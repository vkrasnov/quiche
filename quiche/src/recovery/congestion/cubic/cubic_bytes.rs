...
impl CubicBytes {
    ...
    pub(super) fn congestion_window_after_ack(
        ...
        // converts to integer
        self.estimated_tcp_congestion_window = (self
            .estimated_tcp_congestion_window
            as f32 +
            self.acked_bytes_count as f32 * (self.alpha() * self.mss as f32) /
...
#[cfg(test)]
mod tests {
    use crate::recovery::congestion::MAX_SEGMENT_SIZE;
